...
public class P_2SelectProject {
	...
	@Test
	public void testP_2SelectProject() throws Exception {
		selenium.open("/ProjectBoard/");
		selenium.type("id=email", "sponsor@nu.edu");
		selenium.type("id=password", "sponsor");
		selenium.click("id=login");
		selenium.waitForPageToLoad("30000");
		selenium.open("/ProjectBoard/sponsor/projectList.do?status=project+successfully+added");
