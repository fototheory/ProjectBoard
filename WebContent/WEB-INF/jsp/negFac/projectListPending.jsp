			  	...
			  	<c:if test="${not empty projectList}">
					...
					<div>
					 ...
					 <select name="my_select" class="selectyze">
						...
						<a href="#" style="padding-left:65px;"> | Accept project | </a>	
						<a href="rejectprog.html" style="padding-left:65px;"> | Reject project | </a>						
						<a href="projectList.do?action=submit&id=${map.get('ID')}&dispID=${map.get('DispID')}" style="padding-left:15px;"> | Submit response to the Lead Faculty | </a>
						</c:if>				
						</p>
					</div>
					</c:forEach>
